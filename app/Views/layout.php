        ...
        <div class="navbar-container container-fluid">
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#logout" aria-expanded="false">
                        ...
                        <div class="media-group dropdown-menu animated flipInY">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <div class="avatar avatar-xs avatar-circle">
                                            <img src="<?= base_url('assets') ?>/images/221.jpg" alt="">
                            ...
                            <a href="javascript:void(0)" class="media-group-item">
                                <div class="media">
                                    <div class="media-left">
                                        <div class="avatar avatar-xs avatar-circle">
                                            <img src="<?= base_url('assets') ?>/images/205.jpg" alt="">
                            ...
                            <a href="javascript:void(0)" class="media-group-item">
                                <div class="media">
                                    <div class="media-left">
                                        <div class="avatar avatar-xs avatar-circle">
                                            <img src="<?= base_url('assets') ?>/images/207.jpg" alt="">
                            ...
                            <a href="javascript:void(0)" class="media-group-item">
                                <div class="media">
                                    <div class="media-left">
                                        <div class="avatar avatar-xs avatar-circle">
                                            <img src="<?= base_url('assets') ?>/images/211.jpg" alt="">
                                            <i class="status status-away"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
