            ...
            <div class="widget-body">
                <div class="m-b-lg row">
                    ...
                    <div class="m-b-lg col-md-6 row">
                        <form action="<?= base_url(user()->user_tipe . '/laporan/harian') ?>" class="col-md-6" method="post">
                            <?= csrf_field() ?>
                            <div class="form-group">
                                <label for="datetimepicker4">Pilih Tanggal </label>
                                <div class='input-group date' id='datetimepicker4' data-plugin="datetimepicker" data-options="{ format: 'YYYY-MM-DD', defaultDate: '<?= $tanggal ?>'}">
                    ...
                    <form action="<?= base_url(user()->user_tipe . '/laporan/cetakharian') ?>" class="col-md-6" method="post">
