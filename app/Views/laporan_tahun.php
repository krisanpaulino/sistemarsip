            ...
            <div class="widget-body">
                <div class="m-b-lg row">
                    ...
                    <div class="m-b-lg col-md-6 row">
                        <form action="<?= base_url(user()->user_tipe . '/laporan/tahunan') ?>" class="col-md-6" method="post">
                            <?= csrf_field() ?>
                            <div class="form-group">
                                <label for="datetimepicker4">Pilih Tahun</label>
                                <div class='input-group date' id='datetimepicker4' data-plugin="datetimepicker" data-options="{viewMode: 'years', format: 'YYYY', defaultDate: '<?= $tahun ?>'}">
                    ...
                    <form action="<?= base_url(user()->user_tipe . '/laporan/cetaktahunan') ?>" class="col-md-6" method="post">
                        <input type="hidden" name="tahun" value="<?= $tahun ?>" class="d-none">
